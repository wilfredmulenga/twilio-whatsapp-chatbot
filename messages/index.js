...
' have been recorded worldwide (As of 27-03-2020). Would you like to receive useful information from' +
  'Ministry of Health, WHO, IFRC and UNICEF on how to prevent it? Please reply with "yes" or "no".'
...
const HB = '7.  A requirement for all public places including schools and training institutions.' + '\n' +
...
'10. Social distancing of at least one meter is encouraged when an individual is showing respiratory symptoms such as cough and/or sneezing. Individuals showing such symptoms are urged to stay at home and avoid interacting with the public.'

const HC = '11. Restriction of unnecessary public gatherings' + '\n' +
...
const HD = '14. Mandatory screening of international travelers including truckers, bus operators, and passengers' +
...
const HE = '16. Authorities at all points of entry, including airports, harbours, railway stations and ground crossings' +
...
module.exports = { welcome, mainMenu, no, A, B, C, D, E, F, FA, FB, FC, FD, G, HA, HB, HC, HD, HE }
